...
Status: **reported — apache/hugegraph#3191** (2026-09-03, closed 2026-09-16 by the merge); fixed locally, red/green validated — `patches/0001-fix-core-paging-*.patch`; **PR apache/hugegraph#3207** (2026-09-14, `EdgeCoreTest`/`VertexCoreTest` green on rocksdb and memory), **merged into master 2026-09-16 as `f0056b1d`**.
...
Reported as apache/hugegraph#3199 (closed 2026-09-16 with the merge), fix in apache/hugegraph#3204, merged into master on 2026-09-16 as `af10f44f` (`patches/0002` is the squashed export of the PR branch; the
...
Status: **reproduced on pods 2026-09-20** (`results/pd-disk-full-single/`, chart single preset, PD on a 512 MB loop
